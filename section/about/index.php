        ...
        <section class="pb-0" id="about">
            <div class="container">
                ...
                "></div>
                        ...
                        <h1 class="text-left"><u>ABOUT US</u></h1>
                    </div>
                </div>
            </div>
            <!-- end of .container-->
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 order-lg-1 mb-5 mb-lg-0">
                        <img class="fit-cover rounded-circle w-100" src="/assets/img/gallery/health-care.png"
                            alt="..." />
                    </div>
                    <div class="col-md-6 text-center text-md-start">
                        ...
                        <p>
                            ...
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat vel ea fugit quae delectus
                            dolores! Doloremque vel commodi ullam facere architecto vitae quaerat voluptatibus quidem
                            consequuntur veniam! Impedit minima inventore, aliquam praesentium iste perferendis
                            voluptatum perspiciatis exercitationem rerum commodi tenetur cupiditate! Aliquam et maxime
                            provident delectus! Sed vero dicta inventore.
                        </p>
                        <div class="py-3">
                        </div>
                    </div>
